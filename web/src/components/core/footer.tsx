...
import { CORE_CONFIG, SOCIAL_LINKS } from "@/config/CORE_CONFIG";
...
export default function FooterSection({
  ...
  copyright = `© ${new Date().getFullYear() || 2025} ${CORE_CONFIG.appName}. All rights reserved.`,
  socialMedia = Object.entries(SOCIAL_LINKS)
  ...
  return (
    <footer className={cn("relative overflow-hidden w-full px-8 pt-14", className)}>
